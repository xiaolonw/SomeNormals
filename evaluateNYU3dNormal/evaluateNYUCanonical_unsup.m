...
resultsLoaders = {
    {   'unsup',
         @(i)(sprintf('/nfs.yoda/xiaolonw/faster_rcnn/3dnormal_results/nyud-3dnormals_unsup/200k/%08d.mat',i)),
        dload,
        []
    },
    {   'imagenet',
        @(i)(sprintf('/nfs.yoda/xiaolonw/faster_rcnn/3dnormal_results/nyud-3dnormals/rectify/%08d.mat',i)),
        dload,
        []
    },
    {   'unsup_xavier',
        @(i)(sprintf('/nfs.yoda/xiaolonw/faster_rcnn/3dnormal_results/nyud-3dnormals_unsup_xavier/200k/rectify/%08d.mat',i)),
        dload,
        []
    },
    {   'unsup_carl',
        @(i)(sprintf('/nfs.yoda/xiaolonw/faster_rcnn/3dnormal_results/nyud-3dnormals_oriunsup/100k/rectify/%08d.mat',i)),
        dload,
        []
    },
    {   'scratch',
        @(i)(sprintf('/nfs.yoda/xiaolonw/faster_rcnn/3dnormal_results/nyud-3dnormals_scratch/200k/rectify/%08d.mat',i)),
        dload,
        []
    },
    {   'unsup_track',
        @(i)(sprintf('/nfs.yoda/xiaolonw/faster_rcnn/3dnormal_results/nyud-3dnormals_unsup_valina/100k/%08d.mat',i)),
        dload,
        []
    }
};
...
parfor i=1:imageCount
    ...
    if ~exist(sprintf('/nfs/hn38/users/xiaolonw/evaluateNYU/normals/normalize/rgb_%06d_tri.mat',i))
        continue;
    end
